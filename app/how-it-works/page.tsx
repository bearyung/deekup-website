...
export default function HowItWorksPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-[#F1ECDA] px-6 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-5xl font-bold tracking-tight text-[#1A2E35]">How Deekup works</h1>
          ...
          <div className="mt-8 flex justify-center gap-4">
            <a href="#diners" className="rounded-full bg-[#E8913A] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#c9762a]">
              For diners
            </a>
            <a href="#restaurants" className="rounded-full border border-[#1A2E35]/20 px-6 py-3 text-sm font-semibold text-[#1A2E35] transition-colors hover:bg-[#1A2E35]/5">
              For restaurants
            </a>
          </div>
        </div>
      ...
      <section id="diners" className="bg-white px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-16">
            ...
            <h2 className="text-4xl font-bold tracking-tight text-[#1A2E35]">From app to table in minutes</h2>
          </div>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {dinerSteps.map((step) => (
              <div key={step.step} className="relative rounded-2xl bg-[#F1ECDA] p-8">
                <div className="mb-4 text-[#1A6B5C]">
                  {step.step === "01" && (
                ...
                <div className="mb-4 text-4xl font-bold text-[#1A6B5C]/20">{step.step}</div>
                <h3 className="mb-3 text-lg font-bold text-[#1A2E35]">{step.title}</h3>
                <p className="text-sm leading-relaxed text-[#5a7a82]">{step.description}</p>
              </div>
            ))}
          </div>
          <div className="mt-12 text-center">
            <Link href="/download" className="inline-flex items-center gap-2 rounded-full bg-[#1A6B5C] px-7 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#134f44]">
      ...
      <section id="restaurants" className="bg-[#1A2E35] px-6 py-24 text-white">
        <div className="mx-auto max-w-6xl">
          <div className="mb-16">
            ...
            <h2 className="text-4xl font-bold tracking-tight">From application to first payout</h2>
          </div>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {restaurantSteps.map((step) => (
              <div key={step.step} className="relative rounded-2xl bg-white/5 p-8 border border-white/10">
                ...
                <div className="mb-4 text-4xl font-bold text-white/20">{step.step}</div>
          ...
          <div className="mt-12 text-center">
            <Link href="/for-restaurants" className="inline-flex items-center gap-2 rounded-full bg-[#1A6B5C] px-7 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#134f44]">
      ...
      <section className="bg-[#F1ECDA] px-6 py-24">
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold tracking-tight text-[#1A2E35]">Key terms explained</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            {keyTerms.map((item) => (
              <div key={item.term} className="rounded-2xl bg-white p-6">
                <div className="mb-2 font-bold text-[#1A6B5C]">{item.term}</div>
                <p className="text-sm leading-relaxed text-[#5a7a82]">{item.definition}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto max-w-6xl grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl bg-[#1A6B5C] p-10 text-white text-center flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold">Ready to dine?</h3>
            <p className="mt-3 text-white/80">Download Deekup free and book your first table tonight.</p>
            <div className="mt-6">
              <Link href="/download" className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#1A6B5C] hover:bg-[#F1ECDA]">
                Get the app
              </Link>
            </div>
          </div>
          <div className="rounded-3xl bg-[#1A2E35] p-10 text-white text-center flex flex-col items-center">
            ...
            <div className="mt-6">
              <Link href="/for-restaurants" className="inline-flex items-center gap-2 rounded-full bg-[#1A6B5C] px-6 py-3 text-sm font-semibold text-white hover:bg-[#134f44]">
                Apply now
              </Link>
            </div>
          </div>
